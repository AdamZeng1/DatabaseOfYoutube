- ("High Distinction"),Spr 2018 Weihan Zeng
-- Weihan.Zeng@student.uts.edu.au
-- I am inspired by youtube to modeling the ERD and building this
-- database.
...
ALTER TABLE "videos" ADD CONSTRAINT userNo FOREIGN KEY (userNo)
REFERENCES "users" (userNo) ON DELETE CASCADE;
ALTER TABLE "comments" ADD CONSTRAINT userNo FOREIGN KEY (userNo)
REFERENCES "users" (userNo) ON DELETE CASCADE;
ALTER TABLE "comments" ADD CONSTRAINT videoNo FOREIGN KEY (videoNo)
REFERENCES "videos" (videoNo) ON DELETE CASCADE;
ALTER TABLE "subscriber" ADD CONSTRAINT subscribed FOREIGN KEY
(subscribed) REFERENCES "users" (userNo) ON DELETE CASCADE;
ALTER TABLE "subscriber" ADD CONSTRAINT subscriber FOREIGN KEY
(subscriber) REFERENCES "users" (userNo) ON DELETE CASCADE;
ALTER TABLE "collection" ADD CONSTRAINT userNo FOREIGN KEY (userNo)
REFERENCES "users" (userNo) ON DELETE CASCADE;
ALTER TABLE "collection" ADD CONSTRAINT videoNo FOREIGN KEY
(videoNo) REFERENCES "videos" (videoNo) ON DELETE CASCADE;
ALTER TABLE "recommendation" ADD CONSTRAINT recommender FOREIGN KEY
(recommender) REFERENCES "users" (userNo) ON DELETE CASCADE;
ALTER TABLE "recommendation" ADD CONSTRAINT recommended FOREIGN KEY
(recommended) REFERENCES "users" (userNo) ON DELETE CASCADE;
ALTER TABLE "history" ADD CONSTRAINT fk_history FOREIGN KEY (userNo)
REFERENCES "users" (userNo) ON DELETE CASCADE;
ALTER TABLE "history" ADD CONSTRAINT fk_history_1 FOREIGN KEY
(videoNo) REFERENCES "videos" (videoNo) ON DELETE CASCADE;
ALTER TABLE "videos" ADD CONSTRAINT trendingNo FOREIGN KEY
(trendingNo) REFERENCES "trending" (trendingNo) ON DELETE CASCADE;
